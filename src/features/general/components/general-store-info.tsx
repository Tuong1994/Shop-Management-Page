  ...
  return (
    <>
      <Title className="mb-3" level={4}>
        {lang.general.store.title}
      </Title>
      <Card>
        <CardContent>
          <StoresSelect />
          <InfoRow
            name={lang.general.store.branchId}
            descript={<Badge color={EBadgeColor.BLUE}>#0001</Badge>}
          />
          <InfoRow
            name={lang.general.store.openHour}
            descript={<Badge color={EBadgeColor.GREEN}>6:00 - 23:00</Badge>}
          />
          ...
          <InfoRow
            name={lang.general.store.manager}
            descript={<Badge color={EBadgeColor.PURPLE}>John Williams</Badge>}
          />
          <InfoRow
            name={lang.general.store.revenue}
            descript={<Badge color={EBadgeColor.GREEN}>{formatMoney(6956)}</Badge>}
          />
